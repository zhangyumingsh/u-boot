...
#if defined CONFIG_TARGET_ROCKPI4_RK3399
struct hw_config
{
	int valid;
	int pwm0;
...
#elif defined CONFIG_TARGET_ROCKPIS_RK3308
struct hw_config
{
	int valid;
	int i2c0;
...
#if defined CONFIG_OF_LIBFDT_OVERLAY
#if (defined CONFIG_TARGET_ROCKPI4_RK3399) || (defined CONFIG_TARGET_ROCKPIS_RK3308)
...
static void handle_hw_conf(cmd_tbl_t *cmdtp, struct fdt_header *working_fdt, struct hw_config *hw_conf)
{
	...
	if(hw_conf->pwm1 == VALUE_ON)
	{
		set_hw_property(working_fdt, "/pwm@ff180010", "status", "okay", 5);
	}
	else if(hw_conf->pwm1 == VALUE_OFF)
	{
		set_hw_property(working_fdt, "/pwm@ff180010", "status", "disabled", 9);
	}
	else
	{
		set_hw_property(working_fdt, "/pwm@ff180010", "status", "disabled", 9);
	...
	if(hw_conf->i2c1 == VALUE_ON)
	{
		set_hw_property(working_fdt, "/i2c@ff050000", "status", "okay", 5);
	}
	else if(hw_conf->i2c1 == VALUE_OFF)
	{
		set_hw_property(working_fdt, "/i2c@ff050000", "status", "disabled", 9);
	}
	else
	{
		set_hw_property(working_fdt, "/i2c@ff050000", "status", "disabled", 9);
	...
	//priority: spi0 > uart0 > i2c2
	if(hw_conf->spi0 == VALUE_ON)
	{
		set_hw_property(working_fdt, "/spi@ff120000", "status", "okay", 5);
		set_hw_property(working_fdt, "/serial@ff0a0000", "status", "disabled", 9);
		set_hw_property(working_fdt, "/i2c@ff060000", "status", "disabled", 9);
	}
	else if(hw_conf->spi0 == VALUE_OFF && hw_conf->uart0 == VALUE_ON)
	{
		set_hw_property(working_fdt, "/spi@ff120000", "status", "disabled", 9);
		set_hw_property(working_fdt, "/serial@ff0a0000", "status", "okay", 5);
		set_hw_property(working_fdt, "/i2c@ff060000", "status", "disabled", 9);
	}
	else if(hw_conf->spi0 == VALUE_OFF && hw_conf->uart0 == VALUE_OFF
			&& hw_conf->i2c2 == VALUE_ON)
	{
		set_hw_property(working_fdt, "/spi@ff120000", "status", "disabled", 9);
		set_hw_property(working_fdt, "/serial@ff0a0000", "status", "disabled", 9);
		set_hw_property(working_fdt, "/i2c@ff060000", "status", "okay", 5);
	}
	else
	{
		set_hw_property(working_fdt, "/spi@ff120000", "status", "disabled", 9);
...
static int label_boot(cmd_tbl_t *cmdtp, struct pxe_label *label)
{
	...
	{
		printf("hw_conf.valid = %d\n", hw_conf.valid);
		printf("hw_conf.i2c0 = %d\n", hw_conf.i2c0);
		printf("hw_conf.i2c1 = %d\n", hw_conf.i2c1);
		printf("hw_conf.i2c2 = %d\n", hw_conf.i2c2);
		printf("hw_conf.i2c3 = %d\n", hw_conf.i2c3);
		printf("hw_conf.pwm1 = %d\n", hw_conf.pwm1);
		printf("hw_conf.pwm2 = %d\n", hw_conf.pwm2);
		printf("hw_conf.pwm3 = %d\n", hw_conf.pwm3);
		printf("hw_conf.spi0 = %d\n", hw_conf.spi0);
		printf("hw_conf.spi2 = %d\n", hw_conf.spi2);
		printf("hw_conf.uart0 = %d\n", hw_conf.uart0);
